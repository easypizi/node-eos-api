...
If you use Typescript, you can use the more detailed reference found in the [type declaration file](https://github.com/easypizi/node-eospark-api/blob/master/index.d.ts)
